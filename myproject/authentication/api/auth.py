...
from authentication.repository.user_repository import UsersRepository
from authentication.services.user_service import UsersService, Users
...
class Login(APIView):
    ...
    def __init__(self, service=None):
        ...
        self.service = service or UsersService(UsersRepository())
